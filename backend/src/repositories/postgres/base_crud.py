...
class BasePostgresCRUD:
    ...
    async def get_objects(cls,
                          ...
                          limit: int | None = None,
                          *,
                          session: AsyncSession) -> list[ModelDTO]:
    ...
    async def insert_objects(self,
                            new_objects: list[Mapping[str, Any]],
        ...
        try:
            ...
            logger.error(f"Could not insert object in database: {e.__class__.__name__}: {e}")
            raise